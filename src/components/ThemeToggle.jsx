...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-2 rounded-sm border border-border bg-background hover:bg-secondary/50 text-foreground transition-colors inline-flex items-center justify-center relative w-9 h-9 overflow-hidden"
