    ...
    <div className="bg-background min-h-screen text-foreground overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-20 pb-12">
        <div className="absolute inset-0 z-0 opacity-40">
          <Image
            src="https://loremflickr.com/1200/800/interior,design?lock=21"
            alt="Hero Background"
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container-px max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
            ...
            >
              <Image src="https://loremflickr.com/1200/800/interior,design?lock=22" alt="Material" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" fittingType="fill" />
        ...
        <div className="container-px max-w-7xl mx-auto">
          ...
          >
            <div className="absolute inset-0 z-0 w-full lg:w-1/2 left-1/2 hidden lg:block">
               <Image src="https://loremflickr.com/1200/800/interior,design?lock=23" alt="3D wireframe" className="h-full w-full object-cover opacity-60" fittingType="fill" />
